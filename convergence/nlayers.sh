...
for lc in 0.120 0.080 0.060; do
  t=${lc/./p}
  run_one n3_l5p5_m5_lc${t} $GDS/pcell_l5p5_w7_n3.json $lc
  run_one n3_l10_m5_lc${t}  $GDS/pcell_l10_w7_n3.json  $lc
  run_one n2_l5p5_m5_lc${t} $GDS/n2_l5p5_w7.json       $lc
  run_one n2_l10_m5_lc${t}  $GDS/n2_l10_w7.json        $lc
done
echo "NLAYERS DONE"
